  ...
  const [reviewList, setReviewList] = useState([
    {
      ...
      description:
        "Amison Overseas: Trusted exporter of quality medicines. Diverse offerings, top-notch service, global trust. Preferred choice for pharmaceutical needs.",
      picture:
        "https://static.vecteezy.com/system/resources/thumbnails/030/691/616/small_2x/princess-2d-cartoon-illustraton-on-white-background-high-q-free-photo.jpg",
      experience: "good one",
      views: "2.2k views",
      raating: "4",
    },
  ...
  return (
    <div>
      ...
      <div className="input-box-container">
        ...
        <button type="button" onClick={addReviewList}>
          {" "}
          Add Review
        </button>
      </div>
      <div className="review-container">
        ...
        <div className="user-review-container">
          {reviewList.map((reviewItem, index) => {
            const { id, name, description, picture, views, experience } =
              reviewItem;
            return (
              <Review
                id={id}
